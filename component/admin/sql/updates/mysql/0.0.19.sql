...
(4, 'What does the Manual say?', 'This is all about issues relating to the Manual.', 'http://placekitten.com/600/450'),
(5, 'Frequently Asked Questions', 'This is the place for all your frequently asked questions.', 'http://placekitten.com/600/450');
...
(1, 'My First lesson', 1, 2, 3, 'http://placekitten.com/600/225', NULL, '/resources/board_of_pensions/bop_agenda_201402.pdf', 'My description', '2016-04-07'),
(2, 'My second lesson', NULL, 2, 6, 'http://placekitten.com/600/225', 'Stewardship Ministries', 'http://medialibrary.nazarene.org/media/webinar-charitable-receipting', 'This is my second lesson', '2016-04-06'),
(3, 'My third lesson', 2, 1, 4, 'http://placekitten.com/600/225', NULL, 'https://www.youtube.com/watch?v=z_ZuDHD2FHo', 'This is my third one', '2016-04-07'),
(4, 'Lesson #4!', 1, 2, 1, 'http://placekitten.com/600/225', NULL, 'https://www.brainshark.com/pbusa/Structuring-Pastoral-Comp', 'This is my Fourth lesson', '2016-04-07');
